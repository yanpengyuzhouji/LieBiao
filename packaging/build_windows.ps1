...
python -m PyInstaller --noconfirm --distpath dist --workpath packaging\build-1.0.4 packaging\LieBiao.spec
...
$installer = Resolve-Path release\LieBiao-Setup-1.0.4-win-x64.exe
