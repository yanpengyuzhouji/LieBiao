...
& $python -m PyInstaller --noconfirm --distpath dist --workpath packaging\build-2.0.0 packaging\LieBiao.spec
...
$installer = Resolve-Path release\LieBiao-Setup-2.0.0-win-x64.exe
