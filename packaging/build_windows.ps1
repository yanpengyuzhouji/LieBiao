...
python -m PyInstaller --noconfirm --distpath dist --workpath packaging\build-1.2.2 packaging\LieBiao.spec
...
$installer = Resolve-Path release\LieBiao-Setup-1.2.2-win-x64.exe
