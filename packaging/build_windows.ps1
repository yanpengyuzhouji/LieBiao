...
python -m PyInstaller --noconfirm --distpath dist --workpath packaging\build-1.1.1 packaging\LieBiao.spec
...
$installer = Resolve-Path release\LieBiao-Setup-1.1.1-win-x64.exe
